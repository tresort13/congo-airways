...
function Header(props)
{
    ...
    <Row>
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
           <pre className="text-dark display-6" style={{fontSize: 20}}><Image className="navbar-brand rounded-circle" src={require('./avatar_new.jpg')} type="button" alt="profil" style={{width:40}} ></Image><span ><i>Bonjour {props.username}</i> </span><span className="separateur text-primary"></span><a href="" style={{textDecoration:"none"}}><span className="text-danger"><i onClick={logout}> Logout </i> </span></a></pre>
