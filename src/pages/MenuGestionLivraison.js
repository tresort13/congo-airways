...
function MenuGestionLivraison(props)
{
...
{isDesktop && <Container className='justify-content-center text-center bordure' style={{marginTop:100,backgroundColor:'white',width:750}} >
    ...
    <Row className='justify-content-center pb-3'>
        <Col xs = {6}>
        <Link to="/form_date_vol_livraison" style={{color:'white',textDecorationLine:'none'}}>
        <Button variant="primary" style={{width:400,height:80}} className='btn-lg rounded-pill zoom'>
        <i>Rapport des bagages non livrés </i>
        </Button>
        </Link>
        </Col>
    </Row>
...
{isMobileOrTablet && <Container className='my-auto justify-content-center text-center bordure mb-5' style={{marginTop:100,backgroundColor:'white'}} >
    ...
    <Row className='justify-content-center pb-3'>
        <Col xs={"auto"}>
        <Link to="/form_vol_select_non_livre" style={{color:'white',textDecorationLine:'none'}}>
...
export default MenuGestionLivraison;