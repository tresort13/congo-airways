...
function FormSelectVolBagage(props)
{
...
{isDesktop && <Container className='mx-auto justify-content-center text-center bordure' style={{marginTop:160,backgroundColor:'white',width:750}} >
...
<Form>
    ...
    <Row className='justify-content-center'>
        ...
        <Form.Select name='position' value={volInfo} aria-label="Default select example" onChange={e=>setVolInfo(e.target.value)} required>
         ...
         {volData.map((donnes)=>{
          return <option value={donnes.flight_info} required>{donnes.flight_info}</option>
         })}
         </Form.Select>
         </Form.Group>
        </Col>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/form_enregistrement_bagage" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormSelectVolBagage;