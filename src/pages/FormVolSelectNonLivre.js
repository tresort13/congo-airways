...
function FormVolSelectNonLivre(props)
{
...
{isDesktop && <Container className='justify-content-center text-center bordure' style={{marginTop:160,backgroundColor:'white',width:750}} >
    <Row className='justify-content-center mb-5 pt-3' >
        <Col xs={6}>
            <Link to="/form_date_vol_livraison">
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/vol_bagage_non_livre_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormVolSelectNonLivre;